...
class ClubTeamSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ("id", "name", "sport_type", "members", "captains")
...
class UserSerializer(serializers.ModelSerializer):
    ...
    club_team_member = ClubTeamSerializer(many=True, read_only=True)
    club_team_captain = ClubTeamSerializer(many=True, read_only=True)
